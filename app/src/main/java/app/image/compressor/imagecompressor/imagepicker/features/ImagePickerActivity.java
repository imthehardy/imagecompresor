...
import app.image.compressor.imagecompressor.imagepicker.adapter.FolderPickerAdapter;
import app.image.compressor.imagecompressor.imagepicker.adapter.ImagePickerAdapter;
import app.image.compressor.imagecompressor.imagepicker.features.camera.CameraHelper;
import app.image.compressor.imagecompressor.imagepicker.helper.ImagePickerPreferences;
import app.image.compressor.imagecompressor.imagepicker.helper.IntentHelper;
import app.image.compressor.imagecompressor.imagepicker.listeners.OnFolderClickListener;
import app.image.compressor.imagecompressor.imagepicker.listeners.OnImageClickListener;
...
import app.image.compressor.imagecompressor.imagepicker.view.GridSpacingItemDecoration;
import app.image.compressor.imagecompressor.imagepicker.view.ProgressWheel;
...
import static app.image.compressor.imagecompressor.imagepicker.features.ImagePicker.MODE_SINGLE;
import static app.image.compressor.imagecompressor.imagepicker.helper.ImagePickerPreferences.PREF_WRITE_EXTERNAL_STORAGE_REQUESTED;
